//Создать список, содержащий элементы целого типа.Найти сумму отрицательных
//двухзначных элементов или выдать сообщение, что таких элементов нет.
#include <iostream>
#include <string>
#include "check.h"
#include <Windows.h>
...
int main()
{
	...
	while (!isExit)
	{
		...
		cout << "Выберите пункт:\n"
			...
			<< "5) Найти сумму отрицательных двухзначных чисел в списке\n"
			<< "6) Выход\n"
			<< "Ввовите:   ";
